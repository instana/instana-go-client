...
type SyntheticAlertConfig struct {
	...
	TagFilterExpression   *tagfilter.TagFilter                  `json:"tagFilterExpression,omitempty"`
...
func (r *SyntheticAlertConfig) GetCustomerPayloadFields() []types.CustomPayloadField[any] {
	return r.CustomerPayloadFields
}

// SetCustomerPayloadFields implements the CustomPayloadFieldsAware interface
func (r *SyntheticAlertConfig) SetCustomerPayloadFields(fields []types.CustomPayloadField[any]) {
