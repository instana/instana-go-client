...
type APIToken struct {
	...
	CanCollectNetTraceLogs                               bool   `json:"canCollectNetTraceLogs"`
	...
	CanConfigureCustomEntities                           bool   `json:"canConfigureCustomEntities"`
	CanConfigureWebsiteConversions                       bool   `json:"canConfigureWebsiteConversions"`
	CanConfigureIPFiltering                              bool   `json:"canConfigureIPFiltering"`
	CanConfigureLlmModelPrice                            bool   `json:"canConfigureLLMModelPrice"`
	CanConfigurePersonallyIdentifiableInformationMasking bool   `json:"canConfigurePersonallyIdentifiableInformationMasking"`
	CanDownloadAgentConfiguration                        bool   `json:"canDownloadAgentConfiguration"`
