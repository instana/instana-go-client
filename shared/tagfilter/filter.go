...
func NewStringTagFilter(entity TagFilterEntity, name string, operator types.ExpressionOperator, value string) *TagFilter {
	return &TagFilter{
		Entity:      &entity,
		Name:        &name,
		Operator:    &operator,
...
func NewNumberTagFilter(entity TagFilterEntity, name string, operator types.ExpressionOperator, value int64) *TagFilter {
	return &TagFilter{
		Entity:      &entity,
		Name:        &name,
		Operator:    &operator,
...
func NewTagTagFilter(entity TagFilterEntity, name string, operator types.ExpressionOperator, key string, value string) *TagFilter {
...
func NewBooleanTagFilter(entity TagFilterEntity, name string, operator types.ExpressionOperator, value bool) *TagFilter {
	return &TagFilter{
		Entity:       &entity,
		Name:         &name,
		Operator:     &operator,
...
func NewUnaryTagFilter(entity TagFilterEntity, name string, operator types.ExpressionOperator) *TagFilter {
	return &TagFilter{
		Entity:   &entity,
		Name:     &name,
		Operator: &operator,
...
func NewUnaryTagFilterWithTagKey(entity TagFilterEntity, name string, tagKey *string, operator types.ExpressionOperator) *TagFilter {
	return &TagFilter{
		Entity:   &entity,
		Name:     &name,
		Key:      tagKey,
...
type TagFilter struct {
	...
	LogicalOperator *types.LogicalOperatorType     `json:"logicalOperator"`
