...
const MobileAlertConfigResourcePath = "/api/events/settings/mobile-app-alert-configs"
...
type MobileAlertConfig struct {
	...
	CustomPayloadFields []types.CustomPayloadField[any]    `json:"customPayloadFields"`
...
func (m *MobileAlertConfig) GetCustomerPayloadFields() []types.CustomPayloadField[any] {
...
func (m *MobileAlertConfig) SetCustomerPayloadFields(fields []types.CustomPayloadField[any]) {
