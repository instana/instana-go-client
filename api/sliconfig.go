...
const (
	...
	SliConfigResourcePath = "/api/settings/v2/sli"
)
...
type SliEntity struct {
	...
	GoodEventFilterExpression *tagfilter.TagFilter `json:"goodEventFilterExpression"`
	BadEventFilterExpression  *tagfilter.TagFilter `json:"badEventFilterExpression"`
	FilterExpression          *tagfilter.TagFilter `json:"filterExpression"`
}
